...
/**
 * for the test of this API, I used a NameNode and three datanodes
 * that are placed on 4 machines, the flows are sent to NameNode 
 * and it manages communication with datanodes blocks in terms 
 * of management ..... .
 * if you want to send a stream remotely, you just use a 
 * web service which receives a file and in using this API.
 */
